...
equipment_failure_sensors_df = spark.read.parquet(os.path.join(PATH_FROM, "equipment_failure_sensors"))
...
fact_table_df.write.mode("overwrite").partitionBy("equipment_id", "sensor_id").format("delta").save(os.path.join(PATH_TO, "failure_log_table"))
